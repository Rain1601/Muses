...
export default function ArticlesPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {articles.length === 0 ? (
        <Card className="text-center py-16 border-dashed border-2 border-border/60 bg-background">
          <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-3xl mb-6 mx-auto transition-all duration-300 hover:bg-primary/20">
            🪶
          </div>
